          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="/Thanat_CV.pdf"
                download="Thanat_Thincheelong_CV.pdf"
                className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl flex items-center gap-2"
              >
